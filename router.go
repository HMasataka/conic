...
func NewRouter(clientID string, pc *PeerConnection, logger *logging.Logger) *router.Router {
	...
	reg.Register(domain.MessageTypeSDP, NewSessionDescriptionHandler(clientID, pc, logger))
